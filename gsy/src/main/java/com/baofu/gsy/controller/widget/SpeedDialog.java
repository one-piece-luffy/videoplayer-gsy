...
public class SpeedDialog extends Dialog {
    ...
    public SpeedDialog(@NonNull Context context, String speed, OnSpeedClickListener listener) {
        super(context, R.style.gsy_PlayListDialogStyle);
        this.speed = speed;
        mContext = context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gsy_av_dialog_speed_list);
    ...
    class MyAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(getContext()).inflate(R.layout.gsy_av_item_dialog_speed_list, parent, false);
