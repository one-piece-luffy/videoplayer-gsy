package com.baofu.gsy.controller.widget;
...
public class SpeedBottomSheetDialog extends BottomSheetDialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gsy_av_dialog_speed_list2);
    ...
    class MyAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(getContext()).inflate(R.layout.gsy_av_item_dialog_speed_list2, parent, false);
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
            try {
                ...
                if (itemSpeed == 1.0f) {
                    viewHolder.tv.setText(mContext.getString(R.string.gsy_speed_1_0) + " (默认)");
                } else {
                    viewHolder.tv.setText(item + "x");
                }
                if (curSpeed == itemSpeed) {
                    viewHolder.tv.setTextColor(ContextCompat.getColor(mContext, R.color.dialog_text));
